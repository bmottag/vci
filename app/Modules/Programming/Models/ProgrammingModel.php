...
class ProgrammingModel extends Model
{
    ...
    /**
     * Programaciones activas para una fecha (planner board)
     * @since 21/05/2026
     * @author BMOTTAG
     */
    ...
    /**
     * Workers con day off en una fecha específica (planner board)
     * @since 21/05/2026
     * @author BMOTTAG
     */
    ...
    /**
     * Agregar worker a programación desde el planner board (drag & drop)
     * @since 21/05/2026
     * @author BMOTTAG
     */
    ...
    /**
     * Guardar un campo del worker desde el planner board
     * @since 21/05/2026
     * @author BMOTTAG
     */
    ...
    /**
     * Jobs activos NO programados para una fecha (planner board - project pool)
     * @since 21/05/2026
     * @author BMOTTAG
     */
    ...
    /**
     * Crear nueva programación desde el planner board
     * @since 21/05/2026
     * @author BMOTTAG
     */
    ...
    /**
     * Eliminar proyecto del planning del día (cascade delete lógico)
     * @since 21/05/2026
     * @author BMOTTAG
     */
