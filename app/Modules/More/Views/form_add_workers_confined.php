<script type="text/javascript" src="<?php echo base_url('assets/js/validate/more/workers_confined.js?v=2.0.0'); ?>"></script>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form name="form" id="form" class="form-horizontal" method="post">
						...
						<input type="hidden" id="hddWOS" name="hddWOS" value="<?php echo esc($wos); ?>"/>
