<script type="text/javascript" src="<?php echo base_url("assets/js/validate/template/workers.js?v=1.0.0"); ?>"></script>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-life-saver"></i> TEMPLATE - ADD WORKERS
				</div>
				<div class="panel-body">

					<form  name="form" id="form" class="form-horizontal" method="post" >
						<input type="hidden" id="hddId" name="hddId" value="<?php echo $idTemplate; ?>"/>
