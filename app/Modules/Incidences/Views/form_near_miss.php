<script type="text/javascript" src="<?php echo base_url("assets/js/validate/incidences/near_miss.js?v=2.0.0"); ?>"></script>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<?= view('App\Views\template\signature_component', [
										...
										'otherValue' 	  => $information[0]["id_near_miss"]
									]) ?>
								</div>
							</div>
						</div>
									...
									?>
										...
										<?php
											...
											<?php
												...
												echo "<td class='text-center'>";
											?>
												<a class='btn btn-danger btn-sm' href='<?php echo base_url('incidences/delete-incident-person/' . $data['id_incident_person'] . '/' . $data['fk_id_incident'] . '/1' . '/' . $jobInfo[0]['id_job']) ?>' id="btn-delete">
