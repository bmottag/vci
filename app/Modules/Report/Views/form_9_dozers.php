<?php
				...
				$html = '<h1 align="center" style="color:#337ab7;">DOZERS INSPECTION REPORT</h1>
							<style>
							table {
				...
				$html.= '<table border="0" cellspacing="0" cellpadding="5">
					...
					$html.='<tr bgcolor="#337ab7" style="color:white;">
						...
						$html.='<th align="center"><strong>Blades</strong></th>';
						...
						$html.='<th align="center"><strong>Wincth</strong></th>';
						...
						$html.='<th colspan="3" rowspan="3"></th>';
						$html.='</tr>';
					...
					$html.='<tr bgcolor="#337ab7" style="color:white;">
						...
						$html.='<th colspan="3" rowspan="3" align="center"><strong> </strong></th>';
						$html.='</tr>';
