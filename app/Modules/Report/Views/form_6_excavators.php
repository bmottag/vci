<?php
				...
				$html = '<h1 align="center" style="color:#337ab7;">EXCAVATORS INSPECTION REPORT</h1>
							<style>
							table {
				...
				$html.= '<table border="0" cellspacing="0" cellpadding="5">
					...
					$html.='<tr bgcolor="#337ab7" style="color:white;">
						...
						$html.='<th align="center"><strong>Bucket (Clean up/Digging)</strong></th>';
						...
						$html.='<th align="center"><strong>Tracks</strong></th>';
							if($info[$consecutivo]["tracks"] == 1){
								$html.= '<th align="center"><strong>Y</strong></th>
										 <th align="center"><strong></strong></th>';
							}elseif($info[$consecutivo]["tracks"] == 0){
								$html.='<th align="center"><strong></strong></th>
										 <th align="center"><strong>X</strong></th>';					
							}else{
								$html.='<th align="center"><strong>N/A</strong></th>
						...
						$html.='<th align="center"><strong>Rollers</strong></th>';
							if($info[$consecutivo]["rollers"] == 1){
								$html.= '<th align="center"><strong>Y</strong></th>
										 <th align="center"><strong></strong></th>';
							}elseif($info[$consecutivo]["rollers"] == 0){
								$html.='<th align="center"><strong></strong></th>
										 <th align="center"><strong>X</strong></th>';					
							}else{
								$html.='<th align="center"><strong>N/A</strong></th>
					...
					$html.='<tr bgcolor="#337ab7" style="color:white;">
						...
						$html.='<th align="center"><strong>Boom pins</strong></th>';
							if($info[$consecutivo]["boom_grease"] == 1){
								$html.= '<th align="center"><strong>Y</strong></th>
										 <th align="center"><strong></strong></th>';
							}elseif($info[$consecutivo]["boom_grease"] == 0){
								$html.='<th align="center"><strong></strong></th>
										 <th align="center"><strong>X</strong></th>';					
							}else{
								$html.='<th align="center"><strong>N/A</strong></th>
						...
						$html.='<th align="center"><strong>Rotary Table</strong></th>';
							if($info[$consecutivo]["table_excavator"] == 1){
								$html.= '<th align="center"><strong>Y</strong></th>
										 <th align="center"><strong></strong></th>';
							}elseif($info[$consecutivo]["table_excavator"] == 0){
								$html.='<th align="center"><strong></strong></th>
										 <th align="center"><strong>X</strong></th>';					
							}else{
								$html.='<th align="center"><strong>N/A</strong></th>
						...
						$html.='<th align="center"><strong>Bucket Pins</strong></th>';
							if($info[$consecutivo]["bucket_pins"] == 1){
								$html.= '<th align="center"><strong>Y</strong></th>
										 <th align="center"><strong></strong></th>';
							}elseif($info[$consecutivo]["bucket_pins"] == 0){
								$html.='<th align="center"><strong></strong></th>
										 <th align="center"><strong>X</strong></th>';					
							}else{
								$html.='<th align="center"><strong>N/A</strong></th>
