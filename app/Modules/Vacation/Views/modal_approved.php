<script type="text/javascript" src="<?php echo base_url("assets/js/validate/vacation/approvedModal.js?v=1.0"); ?>"></script>
...
<div class="modal-body">
	<form  name="form" id="form" role="form" method="post" >
		<input type="hidden" id="hddIdParam" name="hddIdParam" value="<?php echo $idVacation; ?>"/>
