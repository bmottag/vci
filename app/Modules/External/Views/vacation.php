<script type="text/javascript" src="<?php echo base_url("assets/js/validate/external/vacation.js?v=1.0.0"); ?>"></script>
<script>
		...
		<div class="col-lg-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<i class="fa fa-suitcase fa-fw"></i> VACATION
				</div>
				<div class="panel-body">
					...
					<form  name="form" id="form" class="form-horizontal" method="post" >
						<input type="hidden" id="hddIdVacation" name="hddIdVacation" value="<?php echo $idVacation; ?>"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<?php echo $vacationInfo[0]["name"]; ?>
							</div>

							<label class="col-sm-2 control-label" for="lastName">Date of Issue:</label>
							<div class="col-sm-2">
								<?php echo $vacationInfo[0]["date_issue"]; ?>
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label" for="firstName">Date start:</label>
							<div class="col-sm-2">
								<?php echo $vacationInfo[0]["date_start"]; ?>
							</div>

							<label class="col-sm-2 control-label" for="lastName">Date end: </label>
							<div class="col-sm-2">
								<?php echo $vacationInfo[0]["date_end"]; ?>
							</div>
						</div>
