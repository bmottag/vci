...
$call_manager = $info[0]["call_manager"] == 1?"Yes":"No";
	...
	$html.= '</th>
					<th bgcolor="#337ab7" style="color:white;"><strong>Did you call your Manager or Supervisor? </strong></th>
					<th>' . $call_manager . '</th>
				</tr>
				<tr>
	...
	$html.= '<br><br>
			<table border="0" cellspacing="0" cellpadding="5">
				<tr>
					...
					<strong>What was the immediate cause?</strong><br>
	...
	$html.= '<br><br>
			<table border="0" cellspacing="0" cellpadding="5">
				<tr>
					<th colspan="3" bgcolor="#337ab7" style="color:white;">
					<strong>What were the contributting factors? </strong><br>
	...
	$html.= '<br><br>
			<table border="0" cellspacing="0" cellpadding="5">
				<tr>
					<th colspan="3" bgcolor="#337ab7" style="color:white;">
					<strong>What training, instruction, orientation, and cautions were given before the incident:</strong> <br>
					</th>
				</tr>		
				<tr>
					<th colspan="3">' . $info[0]['instruction_before']. '</th>
				</tr>
			</table>';
